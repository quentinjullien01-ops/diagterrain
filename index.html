...
.scr.on{display:flex}
.hdr{display:flex;align-items:center;gap:10px;padding:13px 14px 11px;border-bottom:0.5px solid var(--br);background:var(--sf);flex-shrink:0}
...
.nav{display:flex;border-top:0.5px solid var(--br);background:var(--sf);flex-shrink:0}
...
.fi{background:var(--sf);border:0.5px solid var(--br2);border-radius:var(--r);padding:11px 13px;color:var(--tx);font-size:15px;font-family:var(--fn);width:100%;outline:none}
.fi:focus{border-color:var(--ac)}
select.fi{cursor:pointer}
select.fi option{background:var(--sf)}
textarea.fi{min-height:80px;resize:none;line-height:1.5}
.fi-sm{background:var(--bg);border:0.5px solid var(--br2);border-radius:8px;padding:8px 10px;color:var(--tx);font-size:14px;font-family:var(--mo);width:100%;outline:none}
...
.map-hint{position:absolute;top:10px;left:50%;transform:translateX(-50%);background:rgba(15,17,23,.88);border:0.5px solid var(--br2);border-radius:99px;padding:5px 14px;font-size:12px;color:var(--tx2);white-space:nowrap;backdrop-filter:blur(6px);pointer-events:none;transition:opacity .3s}
...
.sh-body{flex:1;overflow-y:auto;padding:14px 18px;display:flex;flex-direction:column;gap:14px}
.sh-foot{padding:14px 18px;border-top:0.5px solid var(--br);flex-shrink:0;display:flex;gap:10px}
/* PIN EDITOR */
...
/* PHOTOS */
.ph-row{display:flex;gap:8px;overflow-x:auto;padding-bottom:2px}
.ph-wrap{position:relative;flex-shrink:0}
.ph-thumb{width:70px;height:70px;border-radius:8px;object-fit:cover;border:0.5px solid var(--br2);display:block}

.ph-add{width:70px;height:70px;border-radius:8px;border:1px dashed var(--br2);background:var(--sf2);display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0}
...
/* HOME */
.home-inner{flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px;gap:0}
...
.h-actions{display:flex;flex-direction:column;gap:10px;width:100%;max-width:380px}
...
.toast{position:fixed;bottom:76px;left:50%;transform:translateX(-50%) translateY(10px);background:var(--sf2);border:0.5px solid var(--br2);border-radius:99px;padding:9px 18px;font-size:13px;color:var(--tx);z-index:400;opacity:0;transition:opacity .2s,transform .2s;pointer-events:none;white-space:nowrap}
.toast.on{opacity:1;transform:translateX(-50%) translateY(0)}
#ibanner{display:none;position:fixed;bottom:0;left:0;right:0;z-index:500;background:var(--ac);padding:12px 16px;align-items:center;gap:12px}
...
<div class="scr on" id="scr-home">
  <div class="home-inner">
    <div class="h-logo-img"><img src="data:image/jpeg;base64," alt="BTP Ingénierie" style="height:36px;width:auto;display:block;margin:0 auto 8px"></div>
  ...
  <div style="flex:1;overflow-y:auto;padding:18px 14px;display:flex;flex-direction:column;gap:18px">
    ...
    <div class="fg">
      ...
      <div class="upz" id="upz" onclick="document.getElementById('plan-file').click()">
        ...
        <p id="up-label">Appuyer pour charger un plan<br><span style="font-size:11px;color:var(--tx3)">PDF, JPG, PNG</span></p>
        <input type="file" id="plan-file" accept="image/*,application/pdf" style="display:none" onchange="handlePlan(this)">
      </div>
    </div>
  </div>
...
async function handlePlan(input){
  ...
  } else { planImg=await toDataURL(f); }
